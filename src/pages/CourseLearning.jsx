...
const CourseLearning = () => {
  ...
  const fetchCourseDetails = () => {
    ...
    const mockCourse = {
      ...
      difficulty: 'Advanced',
      duration: '40 hours',
      description: 'Master advanced React patterns including hooks, context, performance optimization, and architectural patterns.',
      progress: 65,
      enrolled: true,
      ...
      resources: [
        { id: 1, name: 'Course Slides (All Modules)', url: '#', type: 'presentation', size: '45 MB' },
        { id: 2, name: 'Complete Source Code', url: '#', type: 'zip', size: '12 MB' },
        { id: 3, name: 'Cheat Sheet PDF', url: '#', type: 'pdf', size: '2 MB' },
        { id: 4, name: 'Additional Reading List', url: '#', type: 'link', size: '-' },
      ],
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-6">
                      ...
                      <div className="bg-gray-50 p-4 rounded-lg">
                        ...
                        <div className="text-lg font-semibold text-gray-900">{course.difficulty}</div>
                      </div>
                      <div className="bg-gray-50 p-4 rounded-lg">
                ...
                {activeTab === 'video' && currentLesson && (
                  <div className="space-y-4">
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        className={`btn-primary ${
                          completedLessons.includes(currentLesson.id) ? 'opacity-50 cursor-default' : ''
                        }`}
                    ...
                    {currentLesson.resources && currentLesson.resources.length > 0 && (
                      <div className="mt-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-3">Lesson Resources</h3>
