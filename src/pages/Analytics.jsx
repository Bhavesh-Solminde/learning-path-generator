...
const Analytics = () => {
  ...
  const pieData = analyticsData ? [
    { name: 'Completed', value: analyticsData.learningStats?.completed || 0 },
    { name: 'In Progress', value: analyticsData.learningStats?.inProgress || 0 },
    { name: 'Not Started', value: analyticsData.learningStats?.notStarted || 0 },
  ] : [];
  ...
  return (
    <div className="p-8 fade-in">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Track your learning journey and identify areas for growth.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="card p-6">
          ...
          <p className="text-3xl font-bold text-primary">{analyticsData?.learningStats?.totalCourses}</p>
        </div>
        <div className="card p-6">
          <h3 className="text-gray-600 text-sm font-medium mb-2">In Progress</h3>
          <p className="text-3xl font-bold text-yellow-600">{analyticsData?.learningStats?.inProgress}</p>
        </div>
        <div className="card p-6">
          <h3 className="text-gray-600 text-sm font-medium mb-2">Completed</h3>
          <p className="text-3xl font-bold text-green-600">{analyticsData?.learningStats?.completed}</p>
        </div>
        <div className="card p-6">
          <h3 className="text-gray-600 text-sm font-medium mb-2">Not Started</h3>
          <p className="text-3xl font-bold text-gray-600">{analyticsData?.learningStats?.notStarted}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        {/* Completion Trend */}
        <div className="card p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Monthly Completion Rate</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Category Strength */}
        <div className="card p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Category-wise Strengths</h2>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="card p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Learning Distribution</h2>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={pieData}
